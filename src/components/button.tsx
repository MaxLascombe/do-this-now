...
export const Button = ({
  ...
  <button
    ...
    className={overrideTailwindClasses(
      'block flex items-center gap-1 rounded-full border border-black px-2.5 py-2 text-sm font-bold text-white outline-none ring-white ring-offset-0 ring-offset-black hover:border-gray-700 hover:bg-gray-900 focus:z-10 focus:ring disabled:opacity-50 disabled:hover:border-gray-800 disabled:hover:bg-black ' +
        props.className
    )}>
    {!!text && text}
    {(!text || !loading) && (
